...
from mo import seq_ssmap_new, seq_ssmap_free, seq_ssmap_get, seq_ssmap_set, seq_ssmap_size
...
struct SSMap:
    ...
    fn __setitem__(inout self, key: StringLiteral, value: String):
        ...
        seq_ssmap_set(self.ptr, key.data()._as_scalar_pointer(), value._buffer.data.value)
    ...
    fn __getitem__(self, key: StringLiteral) -> String:
        ...
        """
        var n: c_size_t = 0
        let s = seq_ssmap_get(self.ptr, key.data()._as_scalar_pointer(), Pointer[c_size_t].address_of(n))
